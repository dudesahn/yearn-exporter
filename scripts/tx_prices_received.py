...
def main():
    ...
    for event in track(events):
        ...
        print(
            "\nToken address:", token
        )  # use this for debugging when we crash on a token
    ...
    if chain.id == 1:
        data.to_excel(
            "/Users/dudesahn/Documents/GitHub/dudesahn/TestingGround/scripts/tx_prices_received.xlsx",
            index=False,
        )
    else:
        data.to_excel(
            "/Users/dudesahn/Documents/GitHub/dudesahn/TestingGround/scripts/tx_prices_received_ftm.xlsx",
            index=False,
        )
